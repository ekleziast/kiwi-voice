...
class KiwiListener:
    ...
    def __init__(
        ...
        self._barge_in_chunks_required = 3  # РќСѓР¶РЅРѕ 3 С‡Р°РЅРєР° РїРѕРґСЂСЏРґ (~0.9s) РґР»СЏ barge-in
        self._barge_in_volume_multiplier = 3.5  # РџРѕСЂРѕРі РіСЂРѕРјРєРѕСЃС‚Рё Г—3.5 РІРѕ РІСЂРµРјСЏ TTS
        self._barge_in_min_volume = 0.025   # РђР±СЃРѕР»СЋС‚РЅС‹Р№ РјРёРЅРёРјСѓРј РіСЂРѕРјРєРѕСЃС‚Рё РґР»СЏ barge-in
